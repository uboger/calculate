...
var calculator = {
        ...
        for (var i = 0; i < sign.length; i++) {
            ...
            $BUTTON.bind("mousedown", function () {
                ...
                if (calculator.getSign(this) == '+') {
                    ...
                    var val = calculator.getTextValue();
                    if (val == '') {
                        calculator.setTextValueStr('0.');
                        return;
                    } else if (!/\./.test(val)&&val != '') {
                        calculator.setTextValueStr(val+'.');
                        return;
                    } else {
                        return;
                       // $(this).attr("id","point").unbind("mousedown");
                    }
    ...
    setTextValueStr: function (str) {
        calculator.showNumber(str);
    },
